...
class Mcnay(Widget):
    ...
    jump_height = NumericProperty(65)
    ...
    def switch_to_normal(self, dt):
        self.bird_image.source = "images/normal.png"
        Clock.schedule_once(self.stop_jumping, self.jump_time  * (3.0 / 5.0))
...
class Obstacle(Widget):
    ...
    def update_position(self):
        self.gap_top = randint(self.gap_size-40, self.height)
